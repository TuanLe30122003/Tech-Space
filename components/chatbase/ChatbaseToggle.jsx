    ...
    <>
      ...
      <div className="fixed bottom-10 right-10 z-40">
        <button
          ...
          className={`bg-green-500 text-white p-3 rounded-full flex items-center justify-center transition-all duration-300 shadow-lg hover:shadow-xl hover:bg-green-600 hover:scale-110 active:scale-95 ${
      ...
      {isOpen && (
        <>
          ...
          {/* Drawer */}
          <div
            className={`fixed bottom-10 right-10 w-[500px] h-[600px] bg-white shadow-2xl z-50 rounded-lg overflow-hidden flex flex-col transition-all duration-300 ${
              isAnimating
